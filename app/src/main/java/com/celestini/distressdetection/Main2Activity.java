...
//                                    String p = pn.getText().toString();
                                    final String up=mPhoneNumberField.getText().toString();

                                    final DatabaseReference demoRef = ref.child(up);
                                    save.setOnClickListener(new View.OnClickListener() {
                                        ...
                                        public void onClick(View view) {
                                            ...
                                            String p = pn.getText().toString();
                                            map.put(n,p);
                                            demoRef.setValue(map)
                                                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                                                        @Override
                                                        public void onSuccess(Void aVoid) {
                                                            Toast.makeText(Main2Activity.this,"Data Saved", LENGTH_LONG).show();
                                                        }
                                                    });
//                                            mDatabase.setValue(up, map);
                                        }
                                    });
